...
class Asset extends _react.default.PureComponent {
  constructor() {
    ...
    _defineProperty(this, "handleDeleteAsset", asset => {
      var onDeleteComplete = this.props.onDeleteComplete;
      this.setState({
        isDeleting: true
      });
    ...
    _defineProperty(this, "renderMenuItem", item => {
      ...
      }, icon && _react.default.createElement(Icon, null), "\xA0\xA0", title);
    });
  ...
  render() {
    ...
    return _react.default.createElement("a", {
      ...
      onClick: onClick,
      "data-id": asset._id
    }), isDeleting && _react.default.createElement("div", {
    ...
    }, _react.default.createElement(_moreVertIcon.default, null)), dialogType && _react.default.createElement(_default.default, {
    ...
    }), _react.default.createElement(_withReferringDocuments.WithReferringDocuments, {
      id: asset._id
    }, (_ref) => {
      ...
      if (isLoading) {
        return _react.default.createElement(_spinner.default, null, "Loading\u2026");
      }

      return _react.default.createElement("div", null, filteredDocuments.length === 0 ? _react.default.createElement("div", null, "No documents are referencing this asset") : _react.default.createElement(_react.default.Fragment, null, dialogType === 'error' && _react.default.createElement("div", null, _react.default.createElement("h4", {
        className: _Asset.default.dialogSubtitle
      }, filteredDocuments.length > 1 ? `${filteredDocuments.length} documents are using this asset` : 'A document is using this asset'), _react.default.createElement("p", {
        className: _Asset.default.referringDocumentsDescription
      }, `Open the document${referringDocuments.length > 1 ? 's' : ''} and remove the asset before deleting it.`)), _react.default.createElement(_default2.List, null, filteredDocuments.map(doc => {
        ...
        }, _react.default.createElement(_linkIcon.default, null), " Open")));
      }))));
    }))))));
  }
...
_defineProperty(Asset, "propTypes", {
  asset: _propTypes.default.shape({
    _id: _propTypes.default.string,
    referenceCount: _propTypes.default.number,
    url: _propTypes.default.string
  }),
  onClick: _propTypes.default.func,
  onKeyPress: _propTypes.default.func,
  onDeleteComplete: _propTypes.default.func
});